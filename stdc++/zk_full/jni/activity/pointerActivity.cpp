...
static pointerActivity* mActivityPtr;
...
void pointerActivity::registerUserTimer(int id, int time) {
	registerTimer(id, time);
}

void pointerActivity::unregisterUserTimer(int id) {
	unregisterTimer(id);
}

void pointerActivity::resetUserTimer(int id, int time) {
	resetTimer(id, time);
}