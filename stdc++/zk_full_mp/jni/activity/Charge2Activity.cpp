...
static Charge2Activity* mActivityPtr;
...
void Charge2Activity::registerUserTimer(int id, int time) {
	registerTimer(id, time);
}

void Charge2Activity::unregisterUserTimer(int id) {
	unregisterTimer(id);
}

void Charge2Activity::resetUserTimer(int id, int time) {
	resetTimer(id, time);
}
